...
public class TrinityNobleLogoApp {
...
g2d.fillOval(90, 79, 5, 5);
g2d.fillOval(105, 79, 5, 5);


// Draw a square House to the bottom right of the sun
g2d.setColor(Color.orange);
g2d.fillRect(210, 190, 66, 71);
// Draw red door
g2d.setColor(Color.red);
g2d.fillRect(230, 223, 25, 38);
// Draw door outline
g2d.setColor(Color.BLACK);
g2d.setStroke(new BasicStroke(2));
g2d.drawRect(230, 223, 25, 38);
}
};
