    ...
    public static void main(String[] args) 
    {
        ...
        JPanel canvas = new JPanel() 
        {
            ...
            protected void paintComponent(Graphics g) 
            {
                ...
                g2d.setColor(Color.BLUE);
                g2d.drawArc(80, 100, 40, 20, -180, 180);

                // Draw Eyes on the Sun
                g2d.fillOval(80, 85, 12, 12);
                g2d.fillOval(107, 85, 12, 12);

                // Draw a square House to the bottom right of the sun   
                g2d.setColor(Color.DARK_GRAY);
                g2d.fillRect(201, 201, 99, 99);

                // Draw red door
                g2d.setColor(Color.RED);
                g2d.fillRect(235,240,33,60);

                // Draw Door Knob
                g2d.setColor(Color.BLACK);
                g2d.fillOval(258, 270, 5, 5);

                // Draw door outline
                g2d.drawLine(235,240,235,300);
                g2d.drawLine(235,240,268,240);
                g2d.drawLine(268,240,268,300);
                g2d.drawLine(235,300,268,300);
                }  
            };
